    ...
    while True:
        ...
        if num_1 == num_0:
            if count == 1:
                ...
                print(choice(phrases_too_soon))  # возвращает один случайный элемент из списка
                if input('Хочешь сыграть еще раз? Введи "да" или "нет" ').lower() in ['да', 'lf']:
                    start()
                else:
                    print('Приходи, когда появится желание сыграть снова :)')
                ...
                print(choice(phrases_guessed))  # возвращает один случайный элемент из списка
                if input('Хочешь сыграть еще раз? Введи "да" или "нет" ').lower() in ['да', 'lf']:
                    start()
                else:
                    print('Приходи, когда появится желание сыграть снова :)')
...
def is_valid_x(x):  # проверка, что введено именно число
    if x.isdigit() is False:
        print('Ты ввел не число :(')
        print('Что ж, ладно, введи новые числа.')
        start()

def is_valid_xy(x, y):  # задаем границы диапазона
    while x == y:
...
# запуск игры
def start():  # вводим границы диапазона
...
# приглашение в игру
if input('Приветствую тебя в программе! Не желаешь сыграть в игру? Введи "да" или "нет" ').lower() in ['да', 'lf']:
